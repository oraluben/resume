...
\role{实习}{Loom support for Graal Native Image}
\begin{itemize}
  \item{\url{https://github.com/oracle/graal/commits?author=oraluben}}
\end{itemize}

\datedsubsection{\textbf{PingCAP} ，远程}{2020.06 -- 2020.08}
\role{实习}{基于Fuzz技术提升TiDB数据库的可靠性。}
\begin{itemize}
	\item{设计并实现针对配置项的Fuzz工具Matrix。}
\end{itemize}
...
\section{教育经历}
\datedsubsection{\textbf{华东师范大学}，上海}{2017.09 -- 现在}
  硕士在读，专业：软件工程，预计毕业日期： 2021 年 1 月
...
\begin{itemize}[parsep=0.25ex]
  ...
  % compiler theories
  \item \textbf{编译原理}:
    熟悉编译原理相关知识，有基于Clang/LLVM工具链开发的经历。
...
\section{其他}
\begin{itemize}[parsep=0.25ex]
  \item 开源贡献：向LLVM/Clang，Python，Yii等项目提交过代码。
\end{itemize}
